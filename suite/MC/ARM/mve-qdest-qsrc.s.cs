...
0x32,0xee,0x05,0x0e = vcmul.f16 q0, q1, q2, #90
0x34,0xee,0x0a,0xce = vcmul.f16 q6, q2, q5, #0
0x30,0xee,0x0b,0x2e = vcmul.f16 q1, q0, q5, #90
0x30,0xee,0x0a,0x3e = vcmul.f16 q1, q0, q5, #180
0x30,0xee,0x0b,0x3e = vcmul.f16 q1, q0, q5, #270
0x30,0xee,0x03,0x3e = vcmul.f16 q1, q0, q1, #270
0x3e,0xfe,0x0a,0x2e = vcmul.f32 q1, q7, q5, #0
0x38,0xfe,0x05,0x6e = vcmul.f32 q3, q4, q2, #90
0x32,0xfe,0x06,0xbe = vcmul.f32 q5, q1, q3, #180
0x3e,0xfe,0x09,0x1e = vcmul.f32 q0, q7, q4, #270
...
0x0e,0xee,0x0a,0x6f = vhcadd.s8 q3, q7, q5, #90
0x10,0xee,0x0c,0x0f = vhcadd.s16 q0, q0, q6, #90
0x10,0xee,0x0c,0x0f = vhcadd.s16 q0, q0, q6, #90
0x12,0xee,0x00,0x7f = vhcadd.s16 q3, q1, q0, #270
0x28,0xee,0x0a,0x6f = vhcadd.s32 q3, q4, q5, #90
0x2e,0xee,0x04,0xdf = vhcadd.s32 q6, q7, q2, #270
0x30,0xee,0x04,0x2f = vadc.i32 q1, q0, q2
0x32,0xee,0x02,0x1f = vadci.i32 q0, q1, q1
0x00,0xfe,0x04,0x2f = vcadd.i8 q1, q0, q2, #90
0x14,0xfe,0x06,0x0f = vcadd.i16 q0, q2, q3, #90
0x1a,0xfe,0x0a,0x1f = vcadd.i16 q0, q5, q5, #270
0x24,0xfe,0x0a,0x8f = vcadd.i32 q4, q2, q5, #90
0x2a,0xfe,0x00,0xbf = vcadd.i32 q5, q5, q0, #270
...
0x20,0xfe,0x02,0x1f = vcadd.i32 q0, q0, q1, #270
0x90,0xfd,0x42,0x08 = vcadd.f32 q0, q0, q1, #270
0x20,0xee,0x02,0x1f = vhcadd.s32 q0, q0, q1, #270
0x10,0xee,0x02,0x1f = vhcadd.s16 q0, q0, q1, #270
...
0x71,0xfe,0x4d,0x8f = vpste
0x32,0xee,0x04,0x1e = vcmult.f16 q0, q1, q2, #180
0x32,0xee,0x04,0x1e = vcmule.f16 q0, q1, q2, #180
