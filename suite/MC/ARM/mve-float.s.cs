...
0xa0,0xfc,0x4a,0x08 = vcmla.f16 q0, q0, q5, #90
0x2e,0xfd,0x44,0x68 = vcmla.f16 q3, q7, q2, #180
0xae,0xfd,0x4c,0x48 = vcmla.f16 q2, q7, q6, #270
0x3c,0xfc,0x4c,0x48 = vcmla.f32 q2, q6, q6, #0
0xb2,0xfc,0x46,0xe8 = vcmla.f32 q7, q1, q3, #90
0x3a,0xfd,0x46,0x88 = vcmla.f32 q4, q5, q3, #180
0xb4,0xfd,0x4e,0x68 = vcmla.f32 q3, q2, q7, #270
...
0x82,0xfc,0x4e,0x48 = vcadd.f16 q2, q1, q7, #90
0x8a,0xfd,0x4e,0x48 = vcadd.f16 q2, q5, q7, #270
...
0xb0,0xef,0x5e,0x2c = vcvt.f16.s16 q1, q7, #16
0xb5,0xef,0x5e,0x2c = vcvt.f16.s16 q1, q7, #11
0xbd,0xef,0x52,0x2d = vcvt.s16.f16 q1, q1, #3
0xb6,0xff,0x52,0x4c = vcvt.f16.u16 q2, q1, #10
0xbd,0xff,0x50,0x0d = vcvt.u16.f16 q0, q0, #3
0xbf,0xef,0x5e,0x2e = vcvt.f32.s32 q1, q7, #1
0xa0,0xef,0x5e,0x2e = vcvt.f32.s32 q1, q7, #32
0xba,0xef,0x5e,0x2e = vcvt.f32.s32 q1, q7, #6
0xab,0xef,0x50,0x2f = vcvt.s32.f32 q1, q0, #21
...
0xbb,0xff,0xc2,0x03 = vtmt.u32.f32 q0, q1
