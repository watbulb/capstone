...
0x08,0xbf = it eq
0xff,0xaf = addeq r7, sp, #1020
0x08,0xbf = it eq
0x7f,0xb0 = addeq sp, #508
0x0d,0xf1,0x0f,0x07 = add.w r7, sp, #15
0x1d,0xf1,0x10,0x07 = adds.w r7, sp, #16
0x0d,0xf1,0x10,0x08 = add.w r8, sp, #16
0x0d,0xf2,0xfc,0x36 = addw r6, sp, #1020
0x0d,0xf2,0xfb,0x36 = addw r6, sp, #1019
0x08,0xbf = it eq
0xe8,0x44 = addeq r8, sp, r8
0x08,0xbf = it eq
0xe8,0x44 = addeq r8, sp
0x08,0xbf = it eq
...
0x5f,0xea,0x22,0x06 = asrs.w r6, r2, #32
...
0xc2,0xe9,0x40,0x01 = strd r0, r1, [r2, #256]
0xe2,0xe9,0x40,0x01 = strd r0, r1, [r2, #256]!
0xe2,0xe8,0x40,0x01 = strd r0, r1, [r2], #256
